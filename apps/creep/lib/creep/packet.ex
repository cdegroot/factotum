defmodule Creep.Packet do
  ...
  @doc """
  Decode an MQTT packet. We may receive more than a single packet in a network read so we return
  any extra data we see for further processing..
  """
  ...
  def decode(binary) do
    try do
      ...
      exception ->
        Logger.error("Decode problem: #{inspect exception}")
